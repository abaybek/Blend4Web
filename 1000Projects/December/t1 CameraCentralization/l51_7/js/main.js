...
function load() {
    m_data.load("data/l51_7.json", load_cb, preloader_cb);
...
function button_index() {
    // console.log(this.id);
    clicked_button = this.id;
    var eye = new Float32Array([TARGET_POS[clicked_button][0] + 1, TARGET_POS[clicked_button][1] + 1, TARGET_POS[clicked_button][2] + 2]);
    var target = new Float32Array([TARGET_POS[clicked_button][0], TARGET_POS[clicked_button][1], TARGET_POS[clicked_button][2]]);
    console.log(target)
