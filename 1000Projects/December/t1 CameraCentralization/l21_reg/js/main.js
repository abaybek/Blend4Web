...
function load() {
    m_data.load("data/l21_reg.json", load_cb, preloader_cb);
...
function button_index() {
    ...
    var target = new Float32Array([TARGET_POS[clicked_button][0] + 1, TARGET_POS[clicked_button][1], TARGET_POS[clicked_button][2] - 2]);
    console.log(target)
