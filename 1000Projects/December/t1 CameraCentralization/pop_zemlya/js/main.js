...
function load() {
    m_data.load("data/pop_zemlya.json", load_cb, preloader_cb);
...
function button_index() {
    // console.log(this.id);
    clicked_button = this.id;
    var eye = new Float32Array([TARGET_POS[clicked_button][0] +6, TARGET_POS[clicked_button][1]+9, TARGET_POS[clicked_button][2] + 1]);
